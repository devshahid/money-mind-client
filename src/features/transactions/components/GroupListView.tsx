...
const GroupListView = ({ groups, transactions, onGroupClick, onDeleteGroup }: GroupListViewProps): JSX.Element => {
  ...
  const groupsWithSummary = useMemo(
    () => groups.map(g => ({ group: g, summary: computeGroupSummary(g, transactions) })),
    [groups, transactions]
  )
    ...
    return (
      ...
      >
        <Typography color='text.secondary'>
          No groups yet. Select transactions and create a group to get started.
        </Typography>
      </Box>
    )
  }
