...
import { acceptSuggestion, rejectSuggestion } from "../../store/aiSlice";
...
const AIAnnotationSuggestion: React.FC<AIAnnotationSuggestionProps> = ({ transactionId, onAccept }) => {
    ...
    const suggestion = useAppSelector((state) => {
        const suggestions = (state as unknown as { ai: { annotationSuggestions: IAISuggestion[] } }).ai.annotationSuggestions;
...
export default AIAnnotationSuggestion;
